            ...
            .on( "mousemove", function() {
               ...
               if( !s.empty()) {
                    ...
                    if(option=="selection"){ // Make selection
                        dots = d3.selectAll("[status=default]")[0].forEach(function(d,i){
                        ...
                        dots = d3.selectAll("[status=selected]")[0].forEach(function(d,i){
                            var sci = d.__data__.science;
                            var cost = d.__data__.cost;
                            var xCoord = xScale(sci);
                            var yCoord = yScale(cost);
...
function unhighlight_basic_info_box(){
	...
	if(current_view==9 && alternate_highlight==true){
...
var tutorial_selection = "260,305,324,351,356,492,508,596,602,634,641,647,656,660,689,701,705,706,709,727,729,742,744,748,763,772,776,780,788,792,795,802,803,812,814,817,834,848,864,867,874,879,888,893,898,901,907,913,914,931,935,941,945,952,954,962,967,969,977,979,980,1007,1017,1026,1029,1031,1034,1037,1044,1047,1053,1054,1060,1061,1070,1072,1078,1079,1087,1091,1098,1109,1115,1119,1122,1126,1139,1159,1160,1165,1179,1183,1184,1190,1196,1197,1216,1226,1230,1235,1240,1252,1253,1254,1256,1263,1265,1269,1275,1276,1282,1285,1295,1309,1310,1311,1312,1313,1317,1320,1322,1328,1333,1347,1348,1351,1357,1361,1363,1367,1369,1378,1380,1387,1389,1392,1396,1400,1403,1404,1418,1419,1422,1424,1426,1431,1433,1434,1438,1452,1453,1456,1457,1459,1463,1467,1469,1471,1473,1477,1488,1490,1495,1496,1501,1524,1528,1529,1538,1543,1553,1555,1559,1561,1562,1567,1570,1574,1579,1580,1581,1584,1587,1590,1594,1599,1602,1604,1607,1613,1614,1618,1619,1620,1626,1627,1633,1635,1639,1640,1643,1646,1648,1650,1661,1663,1665,1675,1676,1679,1687,1688,1689,1690,1691";
