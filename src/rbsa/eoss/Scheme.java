...
//            if(tmpcnt==0){System.out.println(innermostExpression);}
...
//        Scheme s = new Scheme();
        ...
        } else if(filterName.equalsIgnoreCase("togetherInOrbit") || filterName.equalsIgnoreCase("togetherInOrbit2") || filterName.equalsIgnoreCase("togetherInOrbit3")){
